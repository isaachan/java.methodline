...
public class JavaLexer extends Lexer {
    ...
    public final void mHexDigit() throws RecognitionException {
        try {
            // Java.g:918:10: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // Java.g:918:12: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            {
    ...
    public final void mExponent() throws RecognitionException {
        try {
            // Java.g:931:10: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            // Java.g:931:12: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
            {
    ...
    public final void mFloatTypeSuffix() throws RecognitionException {
        try {
            // Java.g:934:17: ( ( 'f' | 'F' | 'd' | 'D' ) )
            // Java.g:934:19: ( 'f' | 'F' | 'd' | 'D' )
            {
    ...
    public final void mEscapeSequence() throws RecognitionException {
        try {
            // Java.g:946:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UnicodeEscape | OctalEscape )
            int alt23=3;
    ...
    public final void mOctalEscape() throws RecognitionException {
        try {
            // Java.g:953:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            int alt24=3;
    ...
    public final void mUnicodeEscape() throws RecognitionException {
        try {
            // Java.g:960:5: ( '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit )
            // Java.g:960:9: '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit
            {
            match('\\'); 
            match('u'); 
            mHexDigit(); 
    ...
    public final void mLetter() throws RecognitionException {
        try {
            // Java.g:979:5: ( '\\u0024' | '\\u0041' .. '\\u005a' | '\\u005f' | '\\u0061' .. '\\u007a' | '\\u00c0' .. '\\u00d6' | '\\u00d8' .. '\\u00f6' | '\\u00f8' .. '\\u00ff' | '\\u0100' .. '\\u1fff' | '\\u3040' .. '\\u318f' | '\\u3300' .. '\\u337f' | '\\u3400' .. '\\u3d2d' | '\\u4e00' .. '\\u9fff' | '\\uf900' .. '\\ufaff' )
            // Java.g:
            {
    ...
    public final void mJavaIDDigit() throws RecognitionException {
        try {
            // Java.g:996:5: ( '\\u0030' .. '\\u0039' | '\\u0660' .. '\\u0669' | '\\u06f0' .. '\\u06f9' | '\\u0966' .. '\\u096f' | '\\u09e6' .. '\\u09ef' | '\\u0a66' .. '\\u0a6f' | '\\u0ae6' .. '\\u0aef' | '\\u0b66' .. '\\u0b6f' | '\\u0be7' .. '\\u0bef' | '\\u0c66' .. '\\u0c6f' | '\\u0ce6' .. '\\u0cef' | '\\u0d66' .. '\\u0d6f' | '\\u0e50' .. '\\u0e59' | '\\u0ed0' .. '\\u0ed9' | '\\u1040' .. '\\u1049' )
            // Java.g:
            {
